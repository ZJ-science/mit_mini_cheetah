...
void FSM_State_Locomotion<T>::run() {
  ...
  if(this->_data->_desiredStateCommand->returnBackGamepad()->leftTriggerAnalog||main_control_settings.variable[0]==4)
    this->_data->userParameters->cmpc_gait=4;

  if(this->_data->_desiredStateCommand->returnBackGamepad()->leftBumper||main_control_settings.variable[0]==9)
    this->_data->userParameters->cmpc_gait=9;
  if(this->_data->_desiredStateCommand->returnBackGamepad()->rightBumper||main_control_settings.variable[0]==1)
    this->_data->userParameters->cmpc_gait=1;
  
  if(this->_data->_desiredStateCommand->returnBackGamepad()->rightTriggerAnalog||main_control_settings.variable[0]==8)
    this->_data->userParameters->cmpc_gait=8;
  if(main_control_settings.variable[0]==7)
    this->_data->userParameters->cmpc_gait=7;
