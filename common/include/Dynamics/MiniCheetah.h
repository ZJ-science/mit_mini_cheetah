...
Quadruped<T> buildMiniCheetah() {
  ...
  cheetah._bodyMass = 4.0;//3.3
  cheetah._bodyLength = 0.195 * 2;//0.19
  cheetah._bodyWidth = 0.050 * 2;//0.049
  cheetah._bodyHeight = 0.05 * 2;
  cheetah._abadGearRatio = 6;
  cheetah._hipGearRatio = 6;
  cheetah._kneeGearRatio = 6;//9.33
  cheetah._abadLinkLength = 0.07575;  //实际0.085//0.062
  cheetah._hipLinkLength = 0.21; //0.209
  cheetah._kneeLinkLength = 0.21;//0.175
  cheetah._maxLegLength = 0.409;//0.384;
